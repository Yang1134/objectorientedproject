...
/**
 * A class GiantCrabPincer that inherits from WeaponItem and is utilised by the GiantCrab.
 * Deals 208 damage and has a hit rate of 90%.
...
public class GiantCrabPincer extends WeaponItem {
    /**
     * A Skills instance representing the performable Skill the GiantCrab can perform.
     */
    private Skills skills = null;

    /**
     * GiantCrabPincer Constructor.
     ...
     */
    public GiantCrabPincer(String name, char displayChar, int damage, String verb, int hitRate) {
        // Call the WeaponItem parent constructor to set its inherited data attributes.
        super(name, displayChar, damage, verb, hitRate);

        // Set the GiantCrabPincer skill to a SlamAttack object, so that it performs a slam attack.
        this.setSkills(new SlamAttack("slams ground", 208, 90, "slams"));
    ...
    /**
     * Check if GiantCrabPincer can perform a Skill.
