...
/**
 * A class GiantDogHead that inherits from WeaponItem and is utilised by the GiantDog.
 * Deals 314 damage and has a hit rate of 90%.
...
public class GiantDogHead extends WeaponItem {
    /**
     * A Skills instance representing the performable Skill the GiantDog can perform.
     */
    private Skills skills = null;

    /**
     * GiantDogHead Constructor.
     ...
     */
    public GiantDogHead(String name, char displayChar, int damage, String verb, int hitRate) {
        // Call the WeaponItem parent constructor to set its inherited data attributes.
        super(name, displayChar, damage, verb, hitRate);

        // Set the GiantDogHead skill to a SlamAttack object, so that it performs a slam attack.
        this.setSkills(new SlamAttack("slams ground", 314, 90, "slams"));

        // Made GiantDogHead to be not droppable or pickable.
    ...
    /**
     * Check if GiantDogHead can perform a Skill.
